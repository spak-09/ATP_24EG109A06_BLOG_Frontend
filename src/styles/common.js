...
// ─── User List Actions ───────────────────────────────
export const userInfoContainer = "flex items-center justify-between gap-4";
export const userNameText = "text-base font-semibold text-[#1d1d1f]";
export const userActionBtnBase = "text-sm px-4 py-2 rounded-full transition-colors";
export const userActionBtnActive = "bg-[#ff3b30] text-white hover:bg-[#d62c23]";
export const userActionBtnInactive = "bg-[#34c759] text-white hover:bg-[#248a3d]";
